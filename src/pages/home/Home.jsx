                        ...
                        {isHovered && (
                            <div
                                ...
                                style={{
                                    ...
                                    position: 'absolute',
                                    left: mousePosition.x - 180 / 2,
                                    top: mousePosition.y - 180 / 2,
                                    width: '180px',
                                    height: '180px',
                                    borderRadius: '50%',
                                    pointerEvents: 'none',
                            ...
                            >
                                <Row style={{ fontWeight: '600', marginTop: '20%', marginLeft: '60%'}}>
                                    <Col xs={12} xl={12}>
                                        <Image src={ArrowIcon}/>
                                    </Col>
                                </Row>
                                <Row style={{ fontWeight: '600', marginTop: '40%', marginLeft: '5%', fontSize: '18px' }}>
                                    <Col xs={12} xl={12}>
                                <p>My Github</p>
                                    </Col>
                                </Row>
