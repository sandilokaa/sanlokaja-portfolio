                                    ...
                                    <div className="overlay-content">
                                        <Row>
                                            <Col xs={12} xl={12} className="d-flex justify-content-end">
                                                <Image src={ArrowExample} style={{ position: 'absolute', width: window.innerWidth < 576 ? '70px' : '80px', right: '0', top: '0' }} />
                                            </Col>
                                        </Row>
                                        <Row>
                                            <Col xs={12} xl={12}>
                                            ...
                                            <Col xs={12} xl={12}>
                                                <p style={{ fontSize: window.innerWidth < 576 ? '2rem' : '2.25rem', fontWeight: '600' }}>{bestProject.title}</p>
                                            </Col>
                                        </Row>
                                    </div>
                                </div>
